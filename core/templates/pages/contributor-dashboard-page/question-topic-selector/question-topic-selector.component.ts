...
/**
 * @fileoverview Component for the question topic select.
 */
...
@Component({
  selector: 'question-topic-selector',
  templateUrl: './question-topic-selector.component.html'
})
export class QuestionTopicSelectorComponent implements OnInit {
...
angular.module('oppia').directive(
  ...
  downgradeComponent({
    component: QuestionTopicSelectorComponent,
