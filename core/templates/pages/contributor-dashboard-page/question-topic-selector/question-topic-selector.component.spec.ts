...
/**
 * @fileoverview Unit tests for the question topic selector component.
 */
...
import { TranslationTopicSelectorComponent } from
  ...
  'pages/contributor-dashboard-page/question-topic-selector/question-topic-selector.component';
  ...
  beforeEach(() => {
    clickDropdown = () => {
      fixture.debugElement.nativeElement
        .querySelector('.oppia-question-topic-selector-inner-container')
        .click();
      fixture.detectChanges();
    };
    ...
    getDropdownOptionsContainer = () => {
      return fixture.debugElement.nativeElement.querySelector(
        '.oppia-question-topic-selector-dropdown-container');
    };
  });
  ...
  it('should correctly initialize dropdown activeTopicName', () => {
    const dropdown = (
      fixture.nativeElement.querySelector(
        '.oppia-question-topic-selector-inner-container'));
